...
export default function Avatars() {
  return (
    <>
      <PageMeta
        title="React.js Avatars Dashboard | UniSell - React.js Admin Dashboard Template"
        description="This is React.js Avatars Dashboard page for UniSell - React.js Tailwind CSS Admin Dashboard Template"
      />
